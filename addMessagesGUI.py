...
import json
from basicFunctions import gettype, get_response_type, addtotypef
from basicFunctions import match_response_type, add_new_type, respond
import random
